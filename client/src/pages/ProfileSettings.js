...
export default function ProfileSettings() {
    ...
    return (
        <div className="container_profile">
            ...
            {picture}
            <input className={"profile_input"} type={"file"} accept={"image/png, image/gif, image/jpeg"} name={"file"}
                   onChange={handleImage}/>
            <button className="button saveChanges" onClick={handleProfileSettings}>
                Save Changes
            </button>

            <button className="button GoBack" onClick={() => window.location.href = "/dashboard"}>
                Go Back
            </button>
